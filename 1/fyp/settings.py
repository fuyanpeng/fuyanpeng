...
SECRET_KEY = 'k*na7)&amp;s7h*pze*y25tb9+)x!zbx1+a*-32l64dx)v)hg3wxeb'
...
MIDDLEWARE_CLASSES = (
    ...
    'fyp.utils.linaro_django_pagination.middleware.PaginationMiddleware',
)
...
INSTALLED_APPS = (
    ...
    'fyp.utils.rte',
    'fyp.utils.linaro_django_pagination',
    'fyp.blog',
    'fyp.home',
    'fyp.board',
)
